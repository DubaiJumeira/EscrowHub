...
-  When you find a security vunerabilty, flag it immediately with a WARNING comment and fix it without regressing or detroying the code. Never implement insecure patters even if asked.
