...
- User deposit addresses for live assets (BTC/LTC/ETH/USDT); SOL runtime scaffold exists but remains disabled until the first-enable checklist is completed
